...
public class Leptop_Activity extends AppCompatActivity {
    ...
    private void setupSliderIndicator() {
        dotCount = laptopSliderAdapter.getItemCount();
        ...
        for (int i = 0; i < dotCount; i++) {
            dots[i] = new ImageView(Leptop_Activity.this);
            dots[i].setImageDrawable(ContextCompat.getDrawable(Leptop_Activity.this, R.drawable.indicator_non_active));
        ...
        if (dotCount > 0) {
            dots[0].setImageDrawable(ContextCompat.getDrawable(Leptop_Activity.this, R.drawable.indicator_active));
        }
    }
    ...
    private void updateIndicator(int position) {
        ...
        if (position >= 0 && position < dotCount) {
            dots[position].setImageDrawable(ContextCompat.getDrawable(Leptop_Activity.this, R.drawable.indicator_active));
        }
    }
