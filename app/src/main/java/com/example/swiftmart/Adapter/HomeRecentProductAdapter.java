...
public class HomeRecentProductAdapter extends RecyclerView.Adapter<HomeRecentProductAdapter.ViewHolder> {
    Context context;
    ...
    public HomeRecentProductAdapter(Context context, ArrayList<ProductModel> datalist) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.card_home_recent_product, parent, false);
